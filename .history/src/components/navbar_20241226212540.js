...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {showMenu && (
        <div
          className="position-fixed top-0 end-0 bg-white vh-100 vw-75 shadow-lg d-flex flex-column"
          style={{ zIndex: 1050 }}
        >
          ...
          {/* Footer Section */}
          <div className="d-flex justify-content-between align-items-end px-4 pb-4">
            {/* Social Icons */}
